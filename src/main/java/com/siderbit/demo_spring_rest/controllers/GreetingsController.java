package com.siderbit.demo_spring_rest.controllers;
...
import com.siderbit.demo_spring_rest.repositories.UsuarioRepository;
...
public class GreetingsController {
    ...
    @PostMapping(value = "salvar") /* Mapwia a url */
    ...
    @PutMapping(value = "atualizar") /* Mapwia a url */
    @ResponseBody  /* Descrição da Resposta */
    ...
    @DeleteMapping(value = "delete") /* Mapwia a url */
    @ResponseBody  /* Descrição da Resposta */
    ...
    @GetMapping(value = "buscaruserid") /* Mapwia a url */
    @ResponseBody  /* Descrição da Resposta */
    ...
    @GetMapping(value = "buscarPorNome") /* Mapwia a url */
    @ResponseBody  /* Descrição da Resposta */
